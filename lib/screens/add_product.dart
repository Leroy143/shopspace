...
class AddProductScreenState extends State<AddProductScreen> {
  ...
  void addProduct() async{
    ...
    if(_imageURL != null && _imageURL.isNotEmpty){
      ...
      final Product product = Product(_productName, _price, docUser.id, _description, _imageURL, _category,userid: getCurrentUserId(), username: snapshot['name'].toString());
              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      CustomButton(text: "Add Product/Service", onPress: () async{
